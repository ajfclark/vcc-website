...
<article id="event-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php
      ...
      $url="https://maps.googleapis.com/maps/api/staticmap?center=" . $location['lat'] . "," . $location['lng'] . "&zoom=10&size=125x125&maptype=roadmap&markers=color:red%7C" . $location['lat'] . "," . $location['lng'];
      $url = signUrl($url . "&key=" . $google_api_key, 'dB3wo9MlE4ddhM9FVIRBw3HvAHs=');
?>
